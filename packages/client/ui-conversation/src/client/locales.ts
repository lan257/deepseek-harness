...
export const zh = {
  ...
  'chat.loadOlder': '加载更早',
  'chat.toBottom': '回到底部',
  'process.summary': '已执行 {count} 个工具调用',
  ...
  'table.resize': '调整表格宽度',
  'table.resizeTitle': '拖动调整宽度，双击恢复默认',
...
export const en = {
  ...
  'process.summary': '{count} tool calls executed',
  ...
  'table.resize': 'Adjust table width',
  'table.resizeTitle': 'Drag to adjust width; double-click to reset',
